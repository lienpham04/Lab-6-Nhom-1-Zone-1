...
| 3 | *Hỏi đáp (Visual QA) ngoài chuyên môn Y tế* | *Bác sĩ (hoặc người nhà) test chatbot up ảnh chế hoặc hỏi ngoài lề gây lỗi hệ thống.* | *Model Fine-Tuned phải có system prompt Guardrail chặn mọi chủ đề ngoài lề (Off-topic), chỉ trả lời phạm vi giải phẫu hình ảnh y khoa.* |
